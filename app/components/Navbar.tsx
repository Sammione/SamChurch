...
export default function Navbar() {
    ...
    return (
        <div className="w-full">
            {/* Top Branding Bar */}
            <div className="w-full bg-primary py-2 px-4 border-b border-secondary/20 relative overflow-hidden group">
                {/* Subtle shine effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-in-out"></div>

                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-6 text-center relative z-10">
                    <span className="text-secondary text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] font-serif">
                        A Commitment to the Word
                    </span>
                    <div className="hidden sm:block w-px h-3 bg-secondary/30"></div>
                    <span className="text-white/80 text-[10px] md:text-xs font-light italic tracking-wider">
